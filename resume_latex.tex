...
\def\betweenskillsh{\hspace{1.3cm}}
...
\begin{center}
    ...
    Calgary | \href{mailto:carlos.serrouya@ucalgary.ca}{carlos.serrouya@ucalgary.ca} | 250-837-1041 \\
\end{center}
...
\begin{itemize}[leftmargin=.5cm, itemsep=.1cm, before=\subsectionv, after=\postpointsv]
    ...
    \item Managed large SQL datasets on AWS, integrated multiple regression models into SQL functions.
    ...
    \item Processed bird audio recordings from ARUs (Autonomous Recording Units), automating classification using BirdNET.
    \item Used Python scripting to automate image/audio conversion on Linux servers, reducing file sizes for backup.
\end{itemize}
...
\begin{tabbing}
    \locationh \= \kill
    \textbf{Server/Bartender/Host} \> \textit{Village Idiot Bar and Grill} \` 2016-2023 \\
\end{tabbing}
